/*
* InconsistentIndividualSizeAndNumberOfSupportVectorsException.h
...
namespace Spectre::libGenetic
{
    ...
    /// </summary>
    class InconsistentIndividualSizeAndNumberOfSupportVectorsException :
    ...
    public:
        ...
        InconsistentIndividualSizeAndNumberOfSupportVectorsException(size_t individualSize, unsigned int numberOfSupportVectors);
    };
}
