/*
* MaximalPercentageFillupCondition.h
...
/// Checks, if Individual has at max specific percentage amount of true values.
/// </summary>
class MaximalPercentageFillupCondition : public BaseIndividualFeasibilityCondition
{
public:
    /// <summary>
    /// Initializes a new instance of the <see cref="MaximalPercentageFillupCondition"/> class.
    /// </summary>
    /// <param name="maximalPercentageFillup">The maximal fillup.</param>
    /// <param name="condition">The individual feasibility condition.</param>
    MaximalPercentageFillupCondition(double maximalPercentageFillup, std::unique_ptr<BaseIndividualFeasibilityCondition> condition = nullptr);
    /// <summary>
